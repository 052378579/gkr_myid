# Style Guide: Doogle (gkr_my.id) - CodeIgniter 4 Version
...
* **Warna dan Tema Utama:**
  ...
  * *Accent Color* (Warna Aksen): Biru Bootstrap (`#0d6efd`) untuk elemen interaktif (tombol cari, indikator tab, dan pagination).
