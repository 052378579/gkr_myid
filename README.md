...
* **Auto-Crawler & Pelatih AI Dinamis (SDCARD):** Sistem perayap katalog terotomatisasi via Cronjob. Seluruh komputasi pelatih AI dinamis (*Directory-Based Training*) beserta operasi *Hard Reset* kini dipusatkan murni di SDCARD untuk efisiensi memori STB maksimal.
...
* **AI Microservice:** Python 3, FastAPI, PyTorch, FAISS (Berjalan via *systemd daemon* di `/mnt/sdcard/ai-scanner`).
* **Agentic AI & Orchestration:** Kontainer Docker WAHA (Port 3001), n8n (Port 5678), Groq API (Llama-3.1).
