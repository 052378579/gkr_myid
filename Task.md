...
- `[x]` **Penyisipan Kolom Kode BOM pada Tabel Utama:** Menambahkan kolom `Kode BOM` di antara kolom `Gambar` dan `Nama Barang` pada antarmuka `/admin/cari` untuk mempercepat pemindaian visual (*visual scanning*) kode produk oleh operator.
